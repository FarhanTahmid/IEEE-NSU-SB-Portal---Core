...
GOOGLE_CLOUD_TOKEN_PES=os.environ.get('GOOGLE_CLOUD_TOKEN_PES')
GOOGLE_CLOUD_REFRESH_TOKEN_PES=os.environ.get('GOOGLE_CLOUD_REFRESH_TOKEN_PES')
GOOGLE_CLOUD_EXPIRY_PES=os.environ.get('GOOGLE_CLOUD_EXPIRY_PES')

GOOGLE_CLOUD_TOKEN_RAS=os.environ.get('GOOGLE_CLOUD_TOKEN_RAS')
GOOGLE_CLOUD_REFRESH_TOKEN_RAS=os.environ.get('GOOGLE_CLOUD_REFRESH_TOKEN_RAS')
GOOGLE_CLOUD_EXPIRY_RAS=os.environ.get('GOOGLE_CLOUD_EXPIRY_RAS')

GOOGLE_CLOUD_TOKEN_WIE=os.environ.get('GOOGLE_CLOUD_TOKEN_WIE')
GOOGLE_CLOUD_REFRESH_TOKEN_WIE=os.environ.get('GOOGLE_CLOUD_REFRESH_TOKEN_WIE')
GOOGLE_CLOUD_EXPIRY_WIE=os.environ.get('GOOGLE_CLOUD_EXPIRY_WIE')

GOOGLE_CLOUD_TOKEN_IAS=os.environ.get('GOOGLE_CLOUD_TOKEN_IAS')
GOOGLE_CLOUD_REFRESH_TOKEN_IAS=os.environ.get('GOOGLE_CLOUD_REFRESH_TOKEN_IAS')
GOOGLE_CLOUD_EXPIRY_IAS=os.environ.get('GOOGLE_CLOUD_EXPIRY_IAS')